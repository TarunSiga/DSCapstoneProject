...
def main():
    ...
    input_method = st.selectbox("Select Input Method", ["Text", "Voice", "Image","Logout"])
...
def logout():
    st.markdown('<a href="http://127.0.0.1:5500/localGPT/Demo/login.html" target="_self"> Logout </a>', unsafe_allow_html=True)
